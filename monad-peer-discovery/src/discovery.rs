...
mod tests {
    ...
    fn generate_name_record(keypair: &KeyPairType, seq_num: u64) -> MonadNameRecord<SignatureType> {
        ...
        let name_record =
            NameRecord::new_with_authentication(ipaddr_v4, port, port, port + 1000, seq_num);
    ...
    #[test_case(
        None,
        NameRecord::new_with_authentication(*NEW_ADDR.ip(), NEW_ADDR.port(), NEW_ADDR.port(), 9001, 1),
        true,
        NameRecord::new_with_authentication(*NEW_ADDR.ip(), NEW_ADDR.port(), NEW_ADDR.port(), 9001, 1),
        true;
        "first record"
    ...
    #[test_case(
        Some(NameRecord::new_with_authentication(*OLD_ADDR.ip(), OLD_ADDR.port(), OLD_ADDR.port(), 9000, 1)),
        NameRecord::new_with_authentication(*NEW_ADDR.ip(), NEW_ADDR.port(), NEW_ADDR.port(), 9001, 2),
        true,
        NameRecord::new_with_authentication(*NEW_ADDR.ip(), NEW_ADDR.port(), NEW_ADDR.port(), 9001, 2),
        true;
        "newer record"
    ...
    #[test_case(
        Some(NameRecord::new_with_authentication(*OLD_ADDR.ip(), OLD_ADDR.port(), OLD_ADDR.port(), 9000, 1)),
        NameRecord::new_with_authentication(*OLD_ADDR.ip(), OLD_ADDR.port(), OLD_ADDR.port(), 9000, 1),
        true,
        NameRecord::new_with_authentication(*OLD_ADDR.ip(), OLD_ADDR.port(), OLD_ADDR.port(), 9000, 1),
        false;
        "same record"
    ...
    #[test_case(
        Some(NameRecord::new_with_authentication(*NEW_ADDR.ip(), NEW_ADDR.port(), NEW_ADDR.port(), 9001, 2)),
        NameRecord::new_with_authentication(*OLD_ADDR.ip(), OLD_ADDR.port(), OLD_ADDR.port(), 9000, 1),
        false,
        NameRecord::new_with_authentication(*NEW_ADDR.ip(), NEW_ADDR.port(), NEW_ADDR.port(), 9001, 2),
        false;
