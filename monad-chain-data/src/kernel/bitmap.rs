...
use crate::{
    ...
    store::{BlobStore, BlobTable, KvTable, MetaStore, ScannableKvTable},
};

pub const LOCAL_ID_BITS: u32 = 24;
pub const STREAM_PAGE_LOCAL_ID_SPAN: u32 = 65_536;
...
pub struct BitmapTables<M: MetaStore, B: BlobStore> {
    fragments: ScannableKvTable<M>,
    page_meta: KvTable<M>,
    page_blobs: BlobTable<B>,
    open_streams: ScannableKvTable<M>,
}

impl<M: MetaStore, B: BlobStore> BitmapTables<M, B> {
    pub fn new(
        fragments: ScannableKvTable<M>,
        page_meta: KvTable<M>,
        page_blobs: BlobTable<B>,
