...
impl<M: MetaStore, B: BlobStore> LogTables<M, B> {
    ...
    pub const LOG_BITMAP_PAGE_BLOB_TABLE: BlobTableId = BlobTableId::new("log_bitmap_page_blob");
    ...
    fn new(meta_store: M, blob_store: B) -> Self {
        Self {
            ...
            bitmap: BitmapTables::new(
                ...
                blob_store.table(Self::LOG_BITMAP_PAGE_BLOB_TABLE),
    ...
    pub fn bitmap(&self) -> &BitmapTables<M, B> {
        &self.bitmap
    }
